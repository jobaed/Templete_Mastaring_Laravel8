 ...
 <section class="south-blog-area section-padding-100">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-8">
                ...
                <div class="single-blog-area mb-50">
                    ...
                    <div class="blog-post-thumbnail">
                        <img src="asset/frontend/img/blog-img/blog1.jpg" alt="">
                    </div>
                    <!-- Post Content -->
                ...
                <div class="single-blog-area mb-50">
                    <!-- Post Thumbnail -->
                    <div class="blog-post-thumbnail">
                        <img src="asset/frontend/img/blog-img/blog2.jpg" alt="">
                    </div>
                    <!-- Post Content -->
                    <div class="post-content">
                        <!-- Date -->
                ...
                <div class="single-blog-area mb-50">
                    <!-- Post Thumbnail -->
                    <div class="blog-post-thumbnail">
                        <img src="asset/frontend/img/blog-img/blog3.jpg" alt="">
                    </div>
                    <!-- Post Content -->
                    <div class="post-content">
                        <!-- Date -->
            ...
            <!-- Blog Sid Bar Start -->
            @include('frontend.pages.blog.section.sidebar')
            <!-- Blog Sid Bar End -->
